...
function db_count_num ($table, array $where = null, $whereGlue = 'AND', $groupBy = null) {
    $count = db_select_one ($table, array('COUNT(*) AS num'), $where, null, $whereGlue, false, $groupBy);
    return $count['num'];
}

function db_select_one ($table, array $fields, array $where = null, $orderBy = null, $whereGlue = 'AND', $groupBy = null) {
    return db_select ($table, $fields, $where, $orderBy, $whereGlue, false, $groupBy);
}

function db_select_all ($table, array $fields, array $where = null, $orderBy = null, $whereGlue = 'AND', $groupBy = null) {
    return db_select ($table, $fields, $where, $orderBy, $whereGlue, true, $groupBy);
}

function db_select ($table, array $fields, array $where = null, $orderBy = null, $whereGlue = 'AND', $all = true, $groupBy = null) {
...
function log_exception(PDOException $e){
	print_r($e);
}
//_______________________________________________________________________________________________

function db_col_names($db,$table){
	$arr=db_select_all('information_schema.COLUMNS',array('COLUMN_NAME'),array('TABLE_SCHEMA'=>$db,'TABLE_NAME'=>$table));
	$cols=array();
	foreach($arr as $k){
		array_push($cols,$k['COLUMN_NAME']);
	}
	return $cols;	
}
?>